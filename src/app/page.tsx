...
export const metadata: Metadata = {
  ...
  description:
    "Affordable porta potty rental and portable toilet services in 25+ cities. Rent a porta potty for events, construction sites, and weddings. Fast delivery, competitive pricing. Get a quote in 60 seconds!",
  keywords:
  ...
  twitter: {
    ...
    title: "Porta Potty Rentals | Fast Delivery | 25+ Cities | FlushJohn",
    description:
      "Professional porta potty rentals in 25+ cities. Fast delivery, competitive pricing, licensed & insured. Get a quote in 60 seconds!",
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Rental prices start from $150 and vary based on location, rental duration, and unit type. We compare rates from our network of local providers to get you the best price. Get a personalized quote in 60 seconds.",
      },
    },
    {
      "@type": "Question",
