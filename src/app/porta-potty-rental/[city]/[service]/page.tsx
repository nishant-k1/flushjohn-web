...
export async function generateMetadata({
  ...
  const metadata: Metadata = {
    ...
    description: `Affordable ${serviceData.description.toLowerCase()} & portable toilet in ${cityTitle}. Professional porta john & portable restroom. Get a quote in 60 seconds.`,
    other: {
      "geo.region": `US-${state}`,
