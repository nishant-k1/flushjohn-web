...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Affordable porta potty rental & portable toilet services in ${cityTitle}. Professional porta john & portable restroom rentals. Same-day delivery. Get a quote in 60 seconds.`,
    other: {
      "geo.region": `US-${state}`,
