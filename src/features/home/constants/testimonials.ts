  ...
  content: [
    {
      ...
      body: "We've been using FlushJohn for our construction projects in Houston for over a year. Their service is reliable, and the units are always clean and well-maintained. The pricing is competitive, and they handle all the coordination for us.",
      date: "March 15, 2024",
      rating: 5,
      verified: true,
    },
    {
      ...
      body: "Needed a hand wash station during my home renovation. FlushJohn provided excellent service, and the unit was delivered on time and picked up promptly when we were done. Very professional and reliable.",
      date: "April 22, 2024",
      rating: 5,
      verified: true,
    },
    ...
    },
    {
      ...
      body: "Used FlushJohn for a wedding event in Miami. They delivered luxury restroom trailers that were perfect for our outdoor wedding venue. The service was excellent and the units were immaculate. Highly recommend for event planners.",
      date: "June 12, 2024",
      rating: 5,
      verified: true,
    },
    {
      ...
      body: "Managing multiple construction sites across Atlanta, we rely on FlushJohn for reliable porta potty service. They cover all our locations, and the service has been consistent. The quote process is straightforward, and pricing is transparent.",
      date: "July 3, 2024",
      rating: 5,
      verified: true,
    },
    {
      ...
      body: "Organized a music festival in Chicago and needed multiple units. FlushJohn handled the large volume perfectly and delivered on time. The units were well-maintained throughout the event, and their team was responsive to our needs.",
      date: "August 19, 2024",
      rating: 5,
      verified: true,
    },
