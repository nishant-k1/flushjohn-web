...
export default function RichSnippets({
  ...
  const videoSchema = pageType === 'homepage' ? {
    ...
    description: 'Learn about FlushJohn porta potty rental services, our products, and service areas across the United States.',
  ...
  const productListSchema = pageType === 'product' || pageType === 'homepage' ? {
    ...
    description: 'Complete range of porta potty rental options from FlushJohn',
    numberOfItems: 6,
    itemListElement: [
      {
        '@type': 'ListItem',
        ...
        item: {
          ...
          description: 'Basic portable toilet for events and construction',
          image: `${s3assets}/og-image-flushjonn-web.png`,
          offers: {
            '@type': 'Offer',
            price: '100-150',
