...
const SEO = {
  title:
    "Reliable Portable - Home | porta potty rental california and Maryland | porta potty rental near me in Wisconsin | porta john rental Connecticut and Minnesota | portable restroom rental | rent a toilet",
  description:
    "Leading porta potty rental service provider across united states for events, job sites, residence.",
};
