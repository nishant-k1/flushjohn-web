    ...
    <div className={privacyStyles.section}>
      <div className={privacyStyles.container}>
        <div>
            ...
            <div>
              <h3>Introduction</h3>
              <p>Welcome to Rent A Porta. Quengenesis LLC(“us”, “we”, or “our”) operates rentaporta.com (hereinafter referred to as “Service”).
              Our Privacy Policy governs your visit to rentaporta.com, and explains how we collect, safeguard and disclose information that results from your use of our Service. We use your data to provide and improve Service. By using Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions. Our Terms and Conditions (“Terms”) govern all use of our Service and together with the Privacy Policy constitutes your agreement with us (“agreement”).</p>
            </div>
            
            <div>
            <h3>Definitions</h3>
              <ul>
                <li>SERVICE means the rentaporta.com website operated by Quengenesis LLC.</li>
            ...
            <div>
              ...
              <p>We collect several different types of information for various purposes to provide and improve our Service to you. Below are the types of data that we collect.</p>
              <ul>
                <li>
                  <h4>Personal Data</h4>
            ...
            <div>
              ...
              <p>Quengenesis LLC will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
            </div>
            ...
            <div>
              ...
              <ul>
                <li>The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</li>
                ...
                <li>We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</li>
                <li>If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please visit our contact page on the website.</li>
                <li>In certain circumstances, you have the following data protection rights:</li>
                <li>
                  <ul>
            ...
            <div>
              ...
              <ul>
                ...
                <li>users are able to change their personal information via contact page on the website..</li>
              </ul>
            </div>
            ...
            <div>
              <h3> Contact Us</h3>
              <p>If you have any questions about this Privacy Policy, please email us via our contact page on the website.</p>
            </div>
        </div>
      </div>
    </div>
